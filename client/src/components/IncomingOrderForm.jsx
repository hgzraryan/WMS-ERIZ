...
function IncomingOrderForm({data}) {
    return (
        <>
        <article className="a4-page p-0" >
            {/* <header style={{marginBottom:'30px'}}>
                <div className="header-left">
                    <p>Էրիզ ՍՊԸ</p>
                </div>
            </header> */}
            <div className="form-section" style={{display:'flex', justifyContent:'space-between',alignItems:'center',margin:'5px',padding:'5px'}}>
                <div>
            ...
            <section className='form-section' style={{display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column', lineheight:0,margin:0}}>           
                <p>{data?.parnerName}</p> 
            ...
            <section className="form-section" style={{ margin:'10px'}}>
