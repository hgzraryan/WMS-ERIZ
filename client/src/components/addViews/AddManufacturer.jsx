...
import {  REGISTER_MANUFACTURER } from "../../utils/constants";
...
function AddManufacturer({ setIsOpen, refreshData }) {
    ...
    const methods = useForm({
      ...
      const onSubmit = methods.handleSubmit(async (data) => {
        ...
        const updatedData = deleteNullProperties(newManufacturer)
        try {
          await axiosPrivate.post(REGISTER_MANUFACTURER, updatedData, {
