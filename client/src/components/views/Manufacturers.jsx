...
import { MANUFACTURERS_URL } from '../../utils/constants';
...
import ManufacturersTable from '../viewTables/ManufacturersTable';
import AddManufacturer from '../addViews/AddManufacturer';

function Manufacturers() {
    const navigate = useNavigate();
    const { pageNumber } = useParams();
    const confirmManufacturerRef = useRef("");
    ...
    const [searchParams,setSearchParams] = useState(null)
      ...
      const {
        ...
        dataCount,
        dataReceived
      } = useGetData(MANUFACTURERS_URL,currentPage,usersPerPage,searchCount,null,searchParams);
      const pageCount = searchCount?Math.ceil(searchCount/usersPerPage) : Math.ceil(dataCount/usersPerPage)
      const { refreshData,data } = useRefreshData(MANUFACTURERS_URL, usersPerPage,pageNumber);
      useEffect(()=>{
...
//-------------------------PAGINATION---------------------------//  
   ...
   const handlePageClick = ({ selected: selectedPage }) => {
    navigate(`/companies/manufacturers/page/${selectedPage+1}`);
    //updateUsersCount();
  }
 //-------------------------refreshPage-----------------------------------//  
  ...
  return (
    ...
    <Helmet>
        <meta charSet="utf-8" />
        <title>Vteam ERP | Manufacturers</title>
              ...
              <div data-simplebar className="nicescroll-bar">
                <div className="contact-list-view">
                  ...
                  >
                    ...
                    > */}
                      <ManufacturersTable
                         confirmManufacturerRef={confirmManufacturerRef}
