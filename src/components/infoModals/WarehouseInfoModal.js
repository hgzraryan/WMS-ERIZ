...
function WarehouseInfoModal({setModalInfo,modalInfo}) {
    return (
        <Modal
          show={() => true}
          size="md"
                ...
                <div data-simplebar className="nicescroll-bar">
                  <div className="d-flex flex-xxl-nowrap flex-wrap">
                    <div className="contact-info w-100">
                      ...
                      <div className="w-100">
                           <div className="d-flex justify-content-between">  <span>ID </span> <span>{modalInfo.warehouseId}</span></div>
                           <div className="separator-full m-0"></div>
                           <div className="d-flex justify-content-between">  <span>Անվանում </span> <span>{modalInfo.name}</span></div>
                           <div className="separator-full m-0"></div>
                           <div className="d-flex justify-content-between">  <span>Կոդ </span> <span>{modalInfo.code}</span></div>
                           <div className="separator-full m-0"></div>
                           <div className="d-flex justify-content-between">  <span>Վաճառքը թույլատրվում է </span> <span>{modalInfo.salesAllowed===1? 'Այո': 'Ոչ'}</span></div>
                           <div className="separator-full m-0"></div>
